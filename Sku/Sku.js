window.addEventListener('load', function() {
    ...
    window.addEventListener('storage', function(event) {
        ...
        if (decodeURI(event.url).substring(decodeURI(event.url).length - 8, decodeURI(event.url).length) == decodeURI(location.href).substring(decodeURI(location.href).length - 8, decodeURI(location.href).length)) {
            window.close();
    ...
    function bi_zhi_hs() {
        if (window.innerWidth / 1.715 > window.innerHeight) {
            document.documentElement.style.backgroundSize = '100% ' + (window.innerWidth / 1.715) + 'px';
        } else if (window.innerWidth / 1.715 < window.innerHeight) {
            document.documentElement.style.backgroundSize = (window.innerHeight * 1.715) + 'px' + ' 100%';
        }
    }
    bi_zhi_hs();
    window.addEventListener('resize', function() {
    ...
    dhr_shezhi_gns.style.backgroundColor = RGB_zhq(localStorage.bei_jing_color, localStorage.bei_jing_tmd);
    s_jiao_xing.style.borderColor = RGB_zhq(localStorage.bei_jing_color, localStorage.bei_jing_tmd);
    ...
    liu_yan_shezhi_gns.style.backgroundColor = RGB_zhq(localStorage.bei_jing_color, localStorage.bei_jing_tmd);
    liu_yan_s_jiao_xing.style.borderColor = RGB_zhq(localStorage.bei_jing_color, localStorage.bei_jing_tmd);
    top_tou_xian_sc = document.querySelector('.top_tou_xian_sc');
    ...
    sy_shezhi_gns.style.backgroundColor = RGB_zhq(localStorage.bei_jing_color, localStorage.bei_jing_tmd);
    sy_s_jiao_xing = document.querySelector('.sy_s_jiao_xing');
    sy_s_jiao_xing.style.borderColor = RGB_zhq(localStorage.bei_jing_color, localStorage.bei_jing_tmd);
